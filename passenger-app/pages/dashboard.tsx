  ...
  return (
    <Page>
      ...
      <Block strong className="p-4">
        <BlockTitle className="text-lg font-semibold mb-4">
        ...
        <BlockTitle className="text-md font-semibold mb-2">Your Company</BlockTitle>
        <List>
        ...
        <BlockTitle className="text-md font-semibold mb-2 mt-4">Your Details</BlockTitle>
        <List>
